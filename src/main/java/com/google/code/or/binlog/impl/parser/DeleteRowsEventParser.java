...
public class DeleteRowsEventParser extends AbstractRowEventParser {
	//
	private static final Logger LOGGER = LoggerFactory.getLogger(DeleteRowsEventParser.class);
	...
	throws IOException {
		...
		//
		final DeleteRowsEvent event = new DeleteRowsEvent(context.getHeader());
